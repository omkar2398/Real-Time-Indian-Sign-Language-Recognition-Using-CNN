...
if not os.path.exists("my_data/train"):
    os.makedirs("my_data/train")
if not os.path.exists("my_data/test"):
    os.makedirs("my_data/test")

for i in range(1):
    if not os.path.exists("my_data/train/" + str(i)):
        os.makedirs("my_data/train/"+str(i))
    if not os.path.exists("my_data/test/" + str(i)):
        os.makedirs("my_data/test/"+str(i))

string.ascii_uppercase = ['C', 'I', 'L', 'O', 'U', 'V']

for i in string.ascii_uppercase:
    if not os.path.exists("my_data/train/" + i):
        os.makedirs("my_data/train/"+i)
    if not os.path.exists("my_data/test/" + i):
        os.makedirs("my_data/test/"+i)


# Train or test
mode = 'train'
directory = 'my_data/'+mode+'/'
minValue = 40
...
while True:
    ...
    # cv2.putText(frame, "0 : "+str(count['0']), (10, 80),
    # cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "1 : "+str(count['1']), (10, 90),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    cv2.putText(frame, "i : "+str(count['i']), (10, 180),
                cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "j : "+str(count['j']), (10, 190),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "k : "+str(count['k']), (10, 200),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "l : "+str(count['l']), (10, 210),
                cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "m : "+str(count['m']), (10, 220),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "n : "+str(count['n']), (10, 230),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "o : "+str(count['o']), (10, 240),
                cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "p : "+str(count['p']), (10, 250),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "q : "+str(count['q']), (10, 260),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "r : "+str(count['r']), (10, 270),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "s : "+str(count['s']), (10, 280),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "t : "+str(count['t']), (10, 290),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "u : "+str(count['u']), (10, 300),
                cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "v : "+str(count['v']), (10, 310),
                cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "w : "+str(count['w']), (10, 320),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "x : "+str(count['x']), (10, 330),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "y : "+str(count['y']), (10, 340),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    # cv2.putText(frame, "z : "+str(count['z']), (10, 350),
    #             cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    cv2.rectangle(frame, (x1, y1+1), (x2, y2-1), (255, 0, 0), 1)
    # Extracting the ROI
